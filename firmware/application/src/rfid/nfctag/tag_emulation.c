...
static tag_base_handler_map_t tag_base_map[] = {
    ...
    {TAG_SENSE_LF, TAG_TYPE_HITAG2,      lf_tag_data_loadcb,           lf_tag_hitag2_data_savecb,    lf_tag_hitag2_data_factory,    &m_tag_data_lf},
    {TAG_SENSE_LF, TAG_TYPE_HITAG2_PAXTON, lf_tag_data_loadcb,         lf_tag_hitag2_data_savecb,    lf_tag_hitag2_data_factory,    &m_tag_data_lf},
    // MF1 tag emulation
